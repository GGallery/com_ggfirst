        ...
        foreach ($this->studenti[0] as $studente) {
            ...
            ?>
                <tr>
                    ...
                    <td class="data_nascita"><span class="start_span" id="citta"><?php echo $studente['data_nascita']; ?></span>


                    <td class="bottoni">
                        <button><span class="modify_button oi oi-pencil" title="modifica cliente" aria-hidden="true" onclick="modifica(<?php echo $studente['id']; ?>,'<?php echo $studente['nome']; ?>','<?php echo $studente['cognome']; ?>','<?php echo $studente['indirizzo']; ?>','<?php echo $studente['cap']; ?>','<?php echo $studente['citta']; ?>','<?php echo $studente['provincia']; ?>','<?php echo $studente['codice_fiscale']; ?>','<?php echo $studente['data_nascita']; ?>','<?php echo $studente['luogo_nascita']; ?>','<?php echo $studente['prov_nascita']; ?>','<?php echo $studente['telefono']; ?>','<?php echo $studente['cellulare']; ?>','<?php echo $studente['email']; ?>','<?php echo $studente['idcliente']; ?>')"></span></button>
