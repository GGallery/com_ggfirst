...
class ggfirstViewLuoghi extends JViewLegacy {
    ...
    function display($tpl = null)
    {
        ...
        if(JRequest::getVar('search')!=null) {
            ...
            $this->luoghi = $this->getModel()->getLuoghi(null, $denominazione, $offset, $limit);
        }else{
            $this->luoghi = $this->getModel()->getLuoghi(null, null, $offset, $limit);
        }
