...
<div class="table-responsive">
    <h2>PRIMA - GESTIONE CORSI - ANAGRAFICA LUOGHI</h2>
    <table class="table table-striped table-bordered ">
        ...
        <?php
            ...
            foreach ($this->luoghi[0] as $luogo) {
                ...
                ?>
                <tr>
                    <td class="denominazione"><span class="start_span" id="span_denominazione_<?php echo $luogo['id']; ?>"><?php echo $luogo['denominazione']; ?></span>
                        <input id="input_denominazione_<?php echo $luogo['id']; ?>" class="start_hidden_input form-control form-control-sm" type="text" value="<?php echo $luogo['denominazione']; ?>"></td>

                    <td class="indirizzo"><span class="start_span" id="span_indirizzo_<?php echo $luogo['id']; ?>"><?php echo $luogo['indirizzo']; ?></span>
                        <input id="input_indirizzo_<?php echo $luogo['id']; ?>" class="start_hidden_input form-control form-control-sm" type="text" value="<?php echo $luogo['indirizzo']; ?>"></td>

                    <td class="citta"><span class="start_span" id="span_citta_<?php echo $luogo['id']; ?>"><?php echo $luogo['citta']; ?></span>
                        <input id="input_citta_<?php echo $luogo['id']; ?>" class="start_hidden_input form-control form-control-sm" type="text" value="<?php echo $luogo['citta']; ?>"></td>

                    <td class="note"><span class="start_span" id="span_note_<?php echo $luogo['id']; ?>"><?php echo $luogo['note']; ?></span>
                        <TEXTAREA id="input_note_<?php echo $luogo['id']; ?>" class="start_hidden_input form-control form-control-sm"><?php echo $luogo['note']; ?></TEXTAREA></td>


                    <td class="bottoni">
                        <button><span class="modify_button oi oi-pencil" title="modifica aula" aria-hidden="true" id="<?php echo $luogo['id']; ?>"></span></button>
                        <button class="confirm_button" id="confirm_button_<?php echo $luogo['id']; ?>"><span class="oi oi-thumb-up" title="conferma modifiche" aria-hidden="true" id="confirm_span_<?php echo $luogo['id']; ?>"></span></button>
                        <button onclick="deleteclick(<?php echo $luogo['id']; ?>)"><span class="oi oi-delete red" title="cancella aula" aria-hidden="true"></span> </button>
                    </td>
                </tr>
                <?php
...
<div class="form-group form-group-sm">
    <div  class="row insertbox"><div class="col-xs-12 col-md-12"><b>INSERISCI UN NUOVO LUOGO</b></div></div>
...
console.log("modifica");
    ...
    function deleteclick(id) {
        ...
        if(confirm('attenzione, stai cancellando un luogo')==true) {
            jQuery.ajax({
                method: "POST",
                cache: false,
