...
class ggpmModelAttestati  extends JModelLegacy {
    ...
    public function getAttestati($id=null,$id_studente=null,$numero=null,$data_attestato=null,$certificatore=null,$id_credito_map=null, $scadenza_data_minore=null,$scadenza_data_maggiore=null){
        ...
        $query->select('a.id as id, concat( c.titolo,\' \',cr.ruolo,\' \', cr.rischio) as credito, concat(s.cognome,\' \',s.nome) as studente, a.numero as numero, a.data_attestato as data_attestato, a.scadenza as scadenza, a.certificatore as certificatore');
