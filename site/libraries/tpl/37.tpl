...
<table>
    ...
    <tr><td style="width: 100%;text-align: center;font-size: x-large;"><i>del corso</i></td></tr>
    <tr><td style="width: 100%;text-align: center;font-size: xx-large;"><h1>{$data.c_titolo}</h1></td></tr>
    <tr><td style="width: 100%;text-align: center;font-size: x-large;"><i>di aggiornamento per</i></td></tr>
    <tr><td style="width: 100%;text-align: center;font-size: xx-large;"><h1>{$data.p_figura}</h1></td></tr>
    <tr><td style="width: 100%;text-align: center;font-size: xx-large;"><h1>{$data.c_credito}</h1></td></tr>
